        ...
        <div className="relative mx-auto px-4 container">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="gap-8 grid grid-cols-1 md:grid-cols-3">
              {/* Basic Plan */}
              <div className="bg-white shadow-lg p-8 rounded-lg hover:scale-105 transition transform">
              ...
              <div className="bg-blue-600 shadow-lg p-8 rounded-lg text-white hover:scale-105 transition md:-translate-y-4 transform">
